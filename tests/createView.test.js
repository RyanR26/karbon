...
test('update node - add new props: id, class, style, text, data attr', () => {
  ...
  const vNodesArray = [
      vNode('div', 'html', {text: 'this is a new text string', id: 'test-id', class: ['new-class'], style: {color: 'red', 'font-size': '10px'}, data: ['test=test']}, 1, false, _, _, _,'testComponent', 0, ['stateKey1'])
  ];
...
test('update node - remove props: id, class, style, text, data attr', () => {
  ...
  const PrevVNodesArray = [
      vNode('div', 'html', {text: 'this is a new text string', id: 'test-id', class: ['new-class'], style: {color: 'red', 'font-size': '10px'}, data: ['test=test']}, 1, false, _, _, _,'testComponent', 0, ['stateKey1'], oldDomNode)
  ];
  createView(container, vNodesArray, PrevVNodesArray, ['stateKey1'], {}, {} );
...
test('update node - transform props: id, class, style, text, data attr', () => {
  ...
  virtualDom.setInitialized(true);
  const vNodesArray = [
      vNode('div', 'html', {text: 'this is an updated text string', id: 'updated-id', class: ['updated-class'], style: {color: 'blue', 'font-size': '20px'}, data: ['test2=test2']}, 1, false, _, _, _,'testComponent', 0, ['stateKey1'], oldDomNode)
  ];
  const PrevVNodesArray = [
      vNode('div', 'html', {text: 'this is a text string', id: 'test-id', class: ['new-class'], style: {color: 'red', 'font-size': '10px'}, data: ['test=test']}, 1, false, _, _, _,'testComponent', 0, ['stateKey1'], oldDomNode)
  ];
  createView(container, vNodesArray, PrevVNodesArray, ['stateKey1'], {}, {} );
