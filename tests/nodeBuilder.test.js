...
test('component parameters', () => {
  ...
  const testComponent = (props, actions, index) => (e, x, {component, lazy, block}) => {
  ...
  const testComponent2 = (props, actions, index) => (e, x, {component, lazy, block}) => {
...
test('create vDom array - nested component', () => {
  ...
  const testComponent = props => (e, x, {component}) => {
    e('div', {textContent: props.text});
      e('span', {class: ['nested']}); 
        e('a', {href: 'www.test.com', class: ['link','nested']}); x('span');
      x('span');
